...
{
       0,    57,    57,    58,    59,    60,    70,    71,    82,    83,
      84,    85,    86,    87,    88,    89,    90,    91,    92,    93,
      94,    96,    97,   101,   102,   110,   111,   115,   119
};
#endif
...
#line 89 "fb_3_2.y"
  ...
  case 16:
#line 90 "fb_3_2.y"
    { printf("number:%f\n",(yyvsp[(1) - (1)].d));(yyval.a) = newnum((yyvsp[(1) - (1)].d)); ;}
    break;

  case 17:
#line 91 "fb_3_2.y"
    { printf("exp|NAME:%s\n", (yyvsp[(1) - (1)].s)->name);(yyval.a) = newref((yyvsp[(1) - (1)].s)); ;}
    break;

  case 18:
#line 92 "fb_3_2.y"
    { printf("NAME = exp:%s\n", (yyvsp[(1) - (3)].s)->name);(yyval.a) = newasgn((yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].a)); ;}
    break;
...
#line 93 "fb_3_2.y"
  ...
  case 20:
#line 94 "fb_3_2.y"
    { printf("newcall NAME=%s\n",(yyvsp[(1) - (4)].s)->name);(yyval.a) = newcall((yyvsp[(1) - (4)].s), (yyvsp[(3) - (4)].a)); ;}
    break;
...
#line 97 "fb_3_2.y"
  ...
  case 23:
#line 101 "fb_3_2.y"
    { printf("symlist|name:%s\n", (yyvsp[(1) - (1)].s)->name);(yyval.sl) = newsymlist((yyvsp[(1) - (1)].s), NULL); ;}
    break;

  case 24:
#line 102 "fb_3_2.y"
    { printf("symlist|name,symlist:%s\n", (yyvsp[(1) - (3)].s)->name);(yyval.sl) = newsymlist((yyvsp[(1) - (3)].s), (yyvsp[(3) - (3)].sl));;}
    break;
